...
Für den Anfang haben wir einen Startbutten auf dem ersten Screen erstellt, der den Spieler, wenn man ihn anklickt, zum zweiten Screen weiterleitet. Zusätzlich haben wir  diesen Screens auch einen Hintergrund mit einer Unterwasserwelt hinzugefügt. 
Viel weiter sind wir leider noch nicht gekommen, weil wir erst einmal ein wenig Zeit benötigten, um uns mit dem, für uns neuen Programm, auseinanderzusetzen. Zudem sind in dieser Stunde noch einige Fragen offen geblieben, wie zum Beispiel, wie wir ein eigenes "Turtle" erstellen, damit wir die Spielfiguren darstellen können. 
